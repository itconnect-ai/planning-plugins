...
1. 전체 흐름에서 현재 위치: `1 PRD → 2 시안 → 3 FRD → 4 TRD → 5 계획 → 개발` 중 어디까지 완료됐는지 (prd.md, design/ 이미지, frd.md, trd.md, plan.md 존재 여부로 판단. setup.md는 1단계가 만드는 시작 설정 파일이므로 단계 판단에서 제외)
